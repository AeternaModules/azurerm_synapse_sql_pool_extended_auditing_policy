data "azurerm_key_vault_secret" "storage_account_access_key" {
  for_each     = { for k, v in var.synapse_sql_pool_extended_auditing_policies : k => v if v.storage_account_access_key_key_vault_id != null && v.storage_account_access_key_key_vault_secret_name != null }
