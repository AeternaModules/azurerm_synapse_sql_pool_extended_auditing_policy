output "synapse_sql_pool_extended_auditing_policies_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.id }
}
output "synapse_sql_pool_extended_auditing_policies_log_monitoring_enabled" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.log_monitoring_enabled }
}
output "synapse_sql_pool_extended_auditing_policies_retention_in_days" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.retention_in_days }
}
output "synapse_sql_pool_extended_auditing_policies_sql_pool_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.sql_pool_id }
}
output "synapse_sql_pool_extended_auditing_policies_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_account_access_key }
  sensitive   = true
}
output "synapse_sql_pool_extended_auditing_policies_storage_account_access_key_is_secondary" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_account_access_key_is_secondary }
}
output "synapse_sql_pool_extended_auditing_policies_storage_endpoint" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_endpoint }
}
