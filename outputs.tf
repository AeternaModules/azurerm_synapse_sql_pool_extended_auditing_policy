output "synapse_sql_pool_extended_auditing_policies_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.id if v.id != null && length(v.id) > 0 }
}
output "synapse_sql_pool_extended_auditing_policies_log_monitoring_enabled" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.log_monitoring_enabled if v.log_monitoring_enabled != null }
}
output "synapse_sql_pool_extended_auditing_policies_retention_in_days" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.retention_in_days if v.retention_in_days != null }
}
output "synapse_sql_pool_extended_auditing_policies_sql_pool_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.sql_pool_id if v.sql_pool_id != null && length(v.sql_pool_id) > 0 }
}
output "synapse_sql_pool_extended_auditing_policies_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_account_access_key if v.storage_account_access_key != null && length(v.storage_account_access_key) > 0 }
  sensitive   = true
}
output "synapse_sql_pool_extended_auditing_policies_storage_account_access_key_is_secondary" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_account_access_key_is_secondary if v.storage_account_access_key_is_secondary != null }
}
output "synapse_sql_pool_extended_auditing_policies_storage_endpoint" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_extended_auditing_policy.synapse_sql_pool_extended_auditing_policies : k => v.storage_endpoint if v.storage_endpoint != null && length(v.storage_endpoint) > 0 }
}
